    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.textInputContainer}>
          <TextInput style={styles.textInput} autoFocus={true} cursorColor={'#D8D8D8'} placeholder='Name' placeholderTextColor={"#D8D8D8"} underlineColor='transparent' />
          <TextInput style={styles.textInput} autoFocus={true} cursorColor={'#D8D8D8'} placeholder='Email' placeholderTextColor={"#D8D8D8"} />
        </View> 
  
        <View >
        <TouchableOpacity style={styles.button} onPress={() => alert('Button pressed')} ><Text style={{color:"white", fontWeight:"bold", fontSize:20, textAlign:"center"}}>Log in</Text></TouchableOpacity>
        </View> 
